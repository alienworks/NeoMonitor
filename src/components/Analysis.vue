<template>
  <b-container class="an-container text-left">
    ...
    <p>
      所有访问次数：<span>{{ totalDailyVisitTimes }}</span>
    </p>

    <p>
      所有 IP 访问数量：<span>{{ totalDailyIpCount }}</span>
    </p>

    <p>
      今日访问次数：<span>{{ currentDailyVisitTimes }}</span>
    </p>

    <p>
      今日最近一小时访问次数：<span>{{ currentHourlyVisitTimes }}</span>
    </p>

    <p>
      当前时间最近一小时 IP 访问数量：<span>{{ currentHourlyVisitTimes }}</span>
    </p>

    <p>
      当前时间最近一小时所有访问次数：<span>{{ totalHourlyVisitTimes }}</span>
    </p>
  </b-container>
</template>
